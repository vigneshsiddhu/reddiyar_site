...
class FamilyMembersControllerTest < ActionController::TestCase
  ...
  test "should create family_member" do
    assert_difference('FamilyMember.count') do
      post :create, family_member: { age: @family_member.age, email: @family_member.email, gender: @family_member.gender, name: @family_member.name, relationship: @family_member.relationship }
    end
  ...
  test "should update family_member" do
    patch :update, id: @family_member, family_member: { age: @family_member.age, email: @family_member.email, gender: @family_member.gender, name: @family_member.name, relationship: @family_member.relationship }
    assert_redirected_to family_member_path(assigns(:family_member))
  end
